...
func NewAzureMachinePoolMachineController(c client.Client, recorder record.EventRecorder, timeouts reconciler.Timeouts, watchFilterValue string, credCache azure.CredentialCache, deleteStuckVMs bool, deleteStuckVMInterval time.Duration) *AzureMachinePoolMachineController {
